...
ARG CONDA_INSTALLER="Miniconda3-4.5.12-Linux-x86_64.sh"
ARG CONDA_MD5="866ae9dff53ad0874e1d1a60b1ad1ef8"
...
ARG MESOSPHERE_JUPYTER_VERSION="1.4.1-0.35.4"
ARG NB_GID="100"
ARG NB_UID="1000"
ARG NB_USER="jovyan"
...
RUN cd /tmp \
    ...
    && ${CONDA_DIR}/bin/jupyter labextension install beakerx-jupyterlab@1.4.1 \
